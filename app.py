...
# ============================================================
# ★ 风控滑块（专家方案接入点）
#   render_risk_slider() 挂载在侧边栏，返回 0-100 的阈值。
#   注意：必须在数据加载之前调用，确保 risk_threshold 在全局可用。
# ============================================================
...
with tab_signal:
    ...
    if user_plan in ("pro", "pro_plus"):
        ...
        # 显示列：有 risk_level 就展示，没有就降级
        long_cols  = [c for c in ['symbol', 'sector', 'score', 'risk_level', '建议持有'] if True]
